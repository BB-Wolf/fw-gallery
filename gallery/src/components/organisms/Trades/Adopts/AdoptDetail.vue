    ...
    <div class="adopt-page">
        ...
        <main class="content">
            <section class="panel preview" :style="panelRandomStyle(0)">
                ...
                <div>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus dolor officia ullam magnam,
                    cum, modi
                    et eum numquam tenetur, sint odit reprehenderit tempore cumque. Eaque quos natus totam delectus
                    officia.
                </div>
            </section>
