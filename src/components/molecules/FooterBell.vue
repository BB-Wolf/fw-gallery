<template>
    <div class="footer-bell" :class="[{ [activeClass]: hasNotification, [activeBellClass]: hasNotification }]">
        <svg :class="[{ [activeBellClass]: hasNotification }]" fill=" #ffffff" width="60px" height="60px"
